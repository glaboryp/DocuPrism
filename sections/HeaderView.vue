<template>
  <header class="relative z-10 bg-white/80 dark:bg-gray-900/50 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 transition-colors duration-300">
        ...
        <!-- Logo and Title -->
         <NuxtLink to="/">
          <div class="flex items-center space-x-2 sm:space-x-3">
            ...
            <div>
              <h1 class="text-lg sm:text-2xl font-bold text-gray-900 dark:text-white">DocuPrism</h1>
              <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hidden sm:block">On-Device Document Analysis</p>
            </div>
          </div>
        </NuxtLink>
